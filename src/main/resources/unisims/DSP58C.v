...
`endif
  ...
  assign ASYNC_RST_in = ASYNC_RST ^ IS_ASYNC_RST_INVERTED_REG;
  ...
  assign PCIN_in = PCIN;
  assign RSTAD_in = RSTAD ^ IS_RSTAD_INVERTED_REG;
...
`ifndef XIL_XECLIB
  ...
  if ((attr_test == 1'b1) ||
    ...
    $display("Error: [Unisim %s-117] DSP_MODE attribute is set to %s.  Legal values for this attribute are INT24, CINT18 or INT8. Instance: %m", MODULE_NAME, DSP_MODE_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
        ((MREG_REG != 1) &&
         (MREG_REG != 0))) begin
      $display("Error: [Unisim %s-139] MREG attribute is set to %d.  Legal values for this attribute are 1 or 0. Instance: %m", MODULE_NAME, MREG_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-140] OPMODEREG attribute is set to %d.  Legal values for this attribute are 1 or 0. Instance: %m", MODULE_NAME, OPMODEREG_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-142] PREADDINSEL attribute is set to %s.  Legal values for this attribute are A or B. Instance: %m", MODULE_NAME, PREADDINSEL_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
        ((PREG_REG != 1) &&
         (PREG_REG != 0))) begin
      $display("Error: [Unisim %s-143] PREG attribute is set to %d.  Legal values for this attribute are 1 or 0. Instance: %m", MODULE_NAME, PREG_REG);
      attr_err = 1'b1;
    end
  ...
  if ((attr_test == 1'b1) ||
    ...
    $display("Error: [Unisim %s-144] RESET_MODE attribute is set to %s.  Legal values for this attribute are SYNC or ASYNC. Instance: %m", MODULE_NAME, RESET_MODE_REG);
    attr_err = 1'b1;
  end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-146] SEL_MASK attribute is set to %s.  Legal values for this attribute are MASK, C, ROUNDING_MODE1 or ROUNDING_MODE2. Instance: %m", MODULE_NAME, SEL_MASK_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-147] SEL_PATTERN attribute is set to %s.  Legal values for this attribute are PATTERN or C. Instance: %m", MODULE_NAME, SEL_PATTERN_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-148] USE_MULT attribute is set to %s.  Legal values for this attribute are MULTIPLY, DYNAMIC or NONE. Instance: %m", MODULE_NAME, USE_MULT_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-149] USE_PATTERN_DETECT attribute is set to %s.  Legal values for this attribute are NO_PATDET or PATDET. Instance: %m", MODULE_NAME, USE_PATTERN_DETECT_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-150] USE_SIMD attribute is set to %s.  Legal values for this attribute are ONE58, FOUR12, ONE48 or TWO24. Instance: %m", MODULE_NAME, USE_SIMD_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-151] USE_WIDEXOR attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, USE_WIDEXOR_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-152] XORSIMD attribute is set to %s.  Legal values for this attribute are XOR24_34_58_116, XOR12, XOR12_22 or XOR24_48_96. Instance: %m", MODULE_NAME, XORSIMD_REG);
	 attr_err = 1'b1;
    end
...
// DSP_PREADD_DATA wires
  ...
  reg [9:0] AD_DATA_CPLX_reg;
  reg [D_WIDTH-1:0] D_DATA_reg;
  reg [2:0] NEGATE_DATA_reg;
  reg [2:0] NEGATE_DATA_CPLX_reg;
...
// U[50],V[50]  11 when mult[50]=0,  10 when mult[50]=1
  ...
  assign U0U2_INT8_in = (DSP_MODE_BIN == DSP_MODE_INT8) ? {1'b1, mult802} : 19'b0;
  assign U1_INT8_in   = (DSP_MODE_BIN == DSP_MODE_INT8) ? {1'b1, mult81[15:0]}  : 17'b0;
  assign V0V2_INT8_in[18] = (DSP_MODE_BIN == DSP_MODE_INT8) ? ~mult802[17] : 1'b0;
  assign V0V2_INT8_in[17:0] = 18'b0;
  assign V1_INT8_in[16] = (DSP_MODE_BIN == DSP_MODE_INT8) ? ~mult81[16] : 1'b0;
  assign V1_INT8_in[15:0] = 16'b0;
...
//*********************************************************
  ...
  assign AD_in  = ADDSUB ? (D_DATA_mux - PREADD_AB) : (D_DATA_mux + PREADD_AB);
...
// DSP_PREADD_DATA
   ...
   assign B2B1_CPLX = (INMODE_mux[4]) ? B1_DATA_out[17:0] : B2_DATA[17:0];
...
//*********************************************************
   ...
   always @(posedge CLK_in or posedge ASYNC_RST_async) begin
      if ((RSTAD_in && (RESET_MODE_BIN == RESET_MODE_SYNC)) ||
          ...
          ASYNC_RST_async ||
          (ADREG_BIN == 1'b0) || glblGSR) begin
        NEGATE_DATA_CPLX_reg <= 3'b000;
      end else if (CEAD_in) begin
        NEGATE_DATA_CPLX_reg <= {3{CONJ_CPLX_MULT_IN_in}};
      end
   end

   assign D_DATA    = (DREG_BIN == 1'b1) ? D_DATA_reg : 
                      (DSP_MODE_BIN != DSP_MODE_CINT18) ? {5'b0, D_in}  :
                      {13'b0, D_FROM_A_CPLX_in[17], D_FROM_A_CPLX_in};

   assign NEGATE_DATA = (DSP_MODE_BIN == DSP_MODE_CINT18) ?
                    (ADREG_BIN == 1'b1 ) ? NEGATE_DATA_CPLX_reg : {3{CONJ_CPLX_MULT_IN_in}} :
...
//*********************************************************
    ...
    assign AD_DATA_CPLX = (ADREG_BIN == 1'b1) ? AD_DATA_CPLX_reg : AD_CPLX_in;
