...
`endif
 ...
 always  @(negedge clkvco or posedge rst_in_o)
  ...
  always @( posedge clkin1_deskew_in_dly or posedge rst_int) begin
    if (rst_int)
      delay_edge_d1  <= 0;
  ...
  always @(posedge clkfb1_deskew_in_dly or posedge rst_int)
   ...
   always @(clk0_div or clk1_div or clk2_div or clk3_div or 
             fb_d1_det_delay or period_vco_rl or d1_delay_found or rst_in_o or
             ps_deskew1_delay_found) begin
      if(rst_in_o==1) begin
    ...
    always @(posedge d1_delay_found or posedge rst_int) begin
      if(rst_int)
        ...
        repeat(2) #max_pd1_en_clk_period;
        pd1_locked = 1;
      end
    end
