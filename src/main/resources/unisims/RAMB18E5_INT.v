...
// /___/   /\      Filename    : RAMB18E5_INT.v
// \   \  /  \
//  \___\/\___\
//
///////////////////////////////////////////////////////////////////////////////
//  Revision:
//  08/15/2018 - initial from E5
//  End Revision:
///////////////////////////////////////////////////////////////////////////////
...
// define constants
  localparam MODULE_NAME = "RAMB18E5_INT";
...
`ifdef XIL_TIMING
  ...
  wire RSTREGB_delay;
  wire SLEEP_delay;
  wire [10:0] ADDRARDADDR_delay;
  wire [10:0] ADDRBWRADDR_delay;
...
`ifdef XIL_TIMING
  ...
  assign ARST_A_in = (ARST_A !== 1'bz) && (ARST_A_delay ^ IS_ARST_A_INVERTED_REG); // rv 0
  assign ARST_B_in = (ARST_B !== 1'bz) && (ARST_B_delay ^ IS_ARST_B_INVERTED_REG); // rv 0
  ...
  assign CLKARDCLK_in = (CLKARDCLK !== 1'bz) && (CLKARDCLK_delay ^ IS_CLKARDCLK_INVERTED_REG); // rv 0
  assign CLKBWRCLK_in = (CLKBWRCLK !== 1'bz) && (CLKBWRCLK_delay ^ IS_CLKBWRCLK_INVERTED_REG); // rv 0
  assign DINADIN_in = DINADIN_delay;
  assign DINBDIN_in = DINBDIN_delay;
  assign DINPADINP_in = DINPADINP_delay;
  assign DINPBDINP_in = DINPBDINP_delay;
  assign ENARDEN_in = (ENARDEN !== 1'bz) && (ENARDEN_delay ^ IS_ENARDEN_INVERTED_REG); // rv 0
  assign ENBWREN_in = (ENBWREN !== 1'bz) && (ENBWREN_delay ^ IS_ENBWREN_INVERTED_REG); // rv 0
  assign REGCEAREGCE_in = (REGCEAREGCE === 1'bz) || REGCEAREGCE_delay; // rv 1
  assign REGCEB_in = (REGCEB === 1'bz) || REGCEB_delay; // rv 1
  assign RSTRAMARSTRAM_in = (RSTRAMARSTRAM !== 1'bz) && (RSTRAMARSTRAM_delay ^ IS_RSTRAMARSTRAM_INVERTED_REG); // rv 0
  assign RSTRAMB_in = (RSTRAMB !== 1'bz) && (RSTRAMB_delay ^ IS_RSTRAMB_INVERTED_REG); // rv 0
  assign RSTREGARSTREG_in = (RSTREGARSTREG !== 1'bz) && (RSTREGARSTREG_delay ^ IS_RSTREGARSTREG_INVERTED_REG); // rv 0
  assign RSTREGB_in = (RSTREGB !== 1'bz) && (RSTREGB_delay ^ IS_RSTREGB_INVERTED_REG); // rv 0
...
// initialize memory p
  ...
  always @ (*) begin
    if (sdp_mode_wr) begin
      ...
      mem_we_a = {{8{WEA_in[2]}}, {8{WEA_in[0]}}};
      memp_we_a = WEA_in;
    end else if (WRITE_WIDTH_A_BIN == 9)  begin
      mem_we_a = {8'd0, {8{WEA_in[0]}}};
  ...
  always @ (*) begin
    if (WRITE_WIDTH_B_BIN == 36) begin
      mem_we_b = {{8{WEA_in[2]}},{8{WEA_in[0]}},{8{WEBWE_in[2]}},{8{WEBWE_in[0]}}};
      memp_we_b = {WEA_in[2],WEA_in[0],WEBWE_in[2],WEBWE_in[0]};
    end else if (WRITE_WIDTH_B_BIN == 18) begin
      mem_we_b = {16'd0,{8{WEBWE_in[2]}},{8{WEBWE_in[0]}}};
      memp_we_b = {2'd0, WEBWE_in[2],WEBWE_in[0]};
    end else if (WRITE_WIDTH_B_BIN == 9)  begin
      mem_we_b = {24'd0,{8{WEBWE_in[0]}}};
      memp_we_b = {3'd0, WEBWE_in[0]};
...
`ifdef XIL_TIMING
  ...
  assign clkardclk_en_n = IS_CLKARDCLK_INVERTED_REG;
  assign clkardclk_en_p = ~IS_CLKARDCLK_INVERTED_REG;
  assign clkbwrclk_en_n = IS_CLKBWRCLK_INVERTED_REG;
  assign clkbwrclk_en_p = ~IS_CLKBWRCLK_INVERTED_REG;
...
`ifdef XIL_TIMING
    ...
    $recrem (negedge ARST_A, negedge CLKARDCLK, 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, ARST_A_delay, CLKARDCLK_delay);
    $recrem (negedge ARST_A, posedge CLKARDCLK, 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, ARST_A_delay, CLKARDCLK_delay);
    $recrem (negedge ARST_B, negedge CLKBWRCLK, 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, ARST_B_delay, CLKBWRCLK_delay);
    $recrem (negedge ARST_B, posedge CLKBWRCLK, 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, ARST_B_delay, CLKBWRCLK_delay);
    $recrem (posedge ARST_A, negedge CLKARDCLK, 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, ARST_A_delay, CLKARDCLK_delay);
    $recrem (posedge ARST_A, posedge CLKARDCLK, 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, ARST_A_delay, CLKARDCLK_delay);
    $recrem (posedge ARST_B, negedge CLKBWRCLK, 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, ARST_B_delay, CLKBWRCLK_delay);
    $recrem (posedge ARST_B, posedge CLKBWRCLK, 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, ARST_B_delay, CLKBWRCLK_delay);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[10]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[1]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[2]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[3]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[4]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[5]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[6]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[7]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[8]);
    $setuphold (negedge CLKARDCLK, negedge ADDRARDADDR[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[9]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[10]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[11], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[11]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[12], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[12]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[13], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[13]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[14], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[14]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[15], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[15]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[1]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[2]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[3]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[4]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[5]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[6]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[7]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[8]);
    $setuphold (negedge CLKARDCLK, negedge CASDINA[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[9]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[10]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[11]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[12]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[13]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[14]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[15]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[1]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[2]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[3]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[4]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[5]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[6]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[7]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[8]);
    $setuphold (negedge CLKARDCLK, negedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[9]);
    $setuphold (negedge CLKARDCLK, negedge CASDINPA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPA_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge CASDINPA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPA_delay[1]);
    $setuphold (negedge CLKARDCLK, negedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPB_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (negedge CLKARDCLK, negedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[10]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[11]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[12]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[13]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[14]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[15]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[1]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[2]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[3]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[4]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[5]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[6]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[7]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[8]);
    $setuphold (negedge CLKARDCLK, negedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[9]);
    $setuphold (negedge CLKARDCLK, negedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINPADINP_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINPADINP_delay[1]);
    ...
    $setuphold (negedge CLKARDCLK, negedge WEA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[0]);
    $setuphold (negedge CLKARDCLK, negedge WEA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[1]);
    $setuphold (negedge CLKARDCLK, negedge WEA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[2]);
    $setuphold (negedge CLKARDCLK, negedge WEA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[3]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[10]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[1]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[2]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[3]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[4]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[5]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[6]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[7]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[8]);
    $setuphold (negedge CLKARDCLK, posedge ADDRARDADDR[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, ADDRARDADDR_delay[9]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[10]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[11], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[11]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[12], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[12]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[13], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[13]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[14], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[14]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[15], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[15]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[1]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[2]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[3]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[4]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[5]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[6]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[7]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[8]);
    $setuphold (negedge CLKARDCLK, posedge CASDINA[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINA_delay[9]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[10]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[11]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[12]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[13]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[14]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[15]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[1]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[2]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[3]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[4]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[5]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[6]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[7]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[8]);
    $setuphold (negedge CLKARDCLK, posedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINB_delay[9]);
    $setuphold (negedge CLKARDCLK, posedge CASDINPA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPA_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge CASDINPA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPA_delay[1]);
    $setuphold (negedge CLKARDCLK, posedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPB_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (negedge CLKARDCLK, posedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[10]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[11]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[12]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[13]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[14]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[15]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[1]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[2]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[3]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[4]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[5]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[6]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[7]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[8]);
    $setuphold (negedge CLKARDCLK, posedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINADIN_delay[9]);
    $setuphold (negedge CLKARDCLK, posedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINPADINP_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, DINPADINP_delay[1]);
    ...
    $setuphold (negedge CLKARDCLK, posedge WEA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[0]);
    $setuphold (negedge CLKARDCLK, posedge WEA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[1]);
    $setuphold (negedge CLKARDCLK, posedge WEA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[2]);
    $setuphold (negedge CLKARDCLK, posedge WEA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_n, clkardclk_en_n, CLKARDCLK_delay, WEA_delay[3]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[10]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[2]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[3]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[4]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[5]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[6]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[7]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[8]);
    $setuphold (negedge CLKBWRCLK, negedge ADDRBWRADDR[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[9]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[10]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[11]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[12]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[13]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[14]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[15]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[2]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[3]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[4]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[5]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[6]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[7]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[8]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[9]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINPB_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[10]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[11]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[12]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[13]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[14]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[15]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[2]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[3]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[4]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[5]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[6]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[7]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[8]);
    $setuphold (negedge CLKBWRCLK, negedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[9]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[10]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[11]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[12]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[13]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[14]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[15]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[2]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[3]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[4]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[5]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[6]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[7]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[8]);
    $setuphold (negedge CLKBWRCLK, negedge DINBDIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[9]);
    $setuphold (negedge CLKBWRCLK, negedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPADINP_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPADINP_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge DINPBDINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPBDINP_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge DINPBDINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPBDINP_delay[1]);
    ...
    $setuphold (negedge CLKBWRCLK, negedge WEA[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge WEA[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge WEA[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[2]);
    $setuphold (negedge CLKBWRCLK, negedge WEA[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[3]);
    $setuphold (negedge CLKBWRCLK, negedge WEBWE[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[0]);
    $setuphold (negedge CLKBWRCLK, negedge WEBWE[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[1]);
    $setuphold (negedge CLKBWRCLK, negedge WEBWE[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[2]);
    $setuphold (negedge CLKBWRCLK, negedge WEBWE[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[3]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[10]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[2]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[3]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[4]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[5]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[6]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[7]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[8]);
    $setuphold (negedge CLKBWRCLK, posedge ADDRBWRADDR[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, ADDRBWRADDR_delay[9]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[10]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[11]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[12]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[13]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[14]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[15]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[2]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[3]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[4]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[5]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[6]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[7]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[8]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINB_delay[9]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINPB_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[10]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[11]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[12]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[13]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[14]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[15]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[2]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[3]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[4]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[5]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[6]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[7]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[8]);
    $setuphold (negedge CLKBWRCLK, posedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINADIN_delay[9]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[10]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[11]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[12]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[13]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[14]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[15]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[2]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[3]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[4]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[5]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[6]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[7]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[8]);
    $setuphold (negedge CLKBWRCLK, posedge DINBDIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINBDIN_delay[9]);
    $setuphold (negedge CLKBWRCLK, posedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPADINP_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPADINP_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge DINPBDINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPBDINP_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge DINPBDINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, DINPBDINP_delay[1]);
    ...
    $setuphold (negedge CLKBWRCLK, posedge WEA[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge WEA[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge WEA[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[2]);
    $setuphold (negedge CLKBWRCLK, posedge WEA[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEA_delay[3]);
    $setuphold (negedge CLKBWRCLK, posedge WEBWE[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[0]);
    $setuphold (negedge CLKBWRCLK, posedge WEBWE[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[1]);
    $setuphold (negedge CLKBWRCLK, posedge WEBWE[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[2]);
    $setuphold (negedge CLKBWRCLK, posedge WEBWE[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_n, clkbwrclk_en_n, CLKBWRCLK_delay, WEBWE_delay[3]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[10]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[1]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[2]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[3]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[4]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[5]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[6]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[7]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[8]);
    $setuphold (posedge CLKARDCLK, negedge ADDRARDADDR[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[9]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[10]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[11], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[11]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[12], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[12]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[13], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[13]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[14], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[14]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[15], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[15]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[1]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[2]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[3]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[4]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[5]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[6]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[7]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[8]);
    $setuphold (posedge CLKARDCLK, negedge CASDINA[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[9]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[10]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[11]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[12]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[13]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[14]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[15]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[1]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[2]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[3]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[4]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[5]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[6]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[7]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[8]);
    $setuphold (posedge CLKARDCLK, negedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[9]);
    $setuphold (posedge CLKARDCLK, negedge CASDINPA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPA_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge CASDINPA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPA_delay[1]);
    $setuphold (posedge CLKARDCLK, negedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPB_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (posedge CLKARDCLK, negedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[10]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[11]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[12]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[13]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[14]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[15]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[1]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[2]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[3]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[4]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[5]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[6]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[7]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[8]);
    $setuphold (posedge CLKARDCLK, negedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[9]);
    $setuphold (posedge CLKARDCLK, negedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINPADINP_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINPADINP_delay[1]);
    ...
    $setuphold (posedge CLKARDCLK, negedge WEA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[0]);
    $setuphold (posedge CLKARDCLK, negedge WEA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[1]);
    $setuphold (posedge CLKARDCLK, negedge WEA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[2]);
    $setuphold (posedge CLKARDCLK, negedge WEA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[3]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[10]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[1]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[2]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[3]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[4]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[5]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[6]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[7]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[8]);
    $setuphold (posedge CLKARDCLK, posedge ADDRARDADDR[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, ADDRARDADDR_delay[9]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[10]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[11], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[11]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[12], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[12]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[13], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[13]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[14], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[14]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[15], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[15]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[1]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[2]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[3]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[4]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[5]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[6]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[7]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[8]);
    $setuphold (posedge CLKARDCLK, posedge CASDINA[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINA_delay[9]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[10]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[11]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[12]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[13]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[14]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[15]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[1]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[2]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[3]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[4]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[5]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[6]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[7]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[8]);
    $setuphold (posedge CLKARDCLK, posedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINB_delay[9]);
    $setuphold (posedge CLKARDCLK, posedge CASDINPA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPA_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge CASDINPA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPA_delay[1]);
    $setuphold (posedge CLKARDCLK, posedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPB_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (posedge CLKARDCLK, posedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[10]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[11]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[12]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[13]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[14]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[15]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[1]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[2]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[3]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[4]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[5]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[6]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[7]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[8]);
    $setuphold (posedge CLKARDCLK, posedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINADIN_delay[9]);
    $setuphold (posedge CLKARDCLK, posedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINPADINP_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, DINPADINP_delay[1]);
    ...
    $setuphold (posedge CLKARDCLK, posedge WEA[0], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[0]);
    $setuphold (posedge CLKARDCLK, posedge WEA[1], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[1]);
    $setuphold (posedge CLKARDCLK, posedge WEA[2], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[2]);
    $setuphold (posedge CLKARDCLK, posedge WEA[3], 0:0:0, 0:0:0, notifier, clkardclk_en_p, clkardclk_en_p, CLKARDCLK_delay, WEA_delay[3]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[10]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[2]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[3]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[4]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[5]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[6]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[7]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[8]);
    $setuphold (posedge CLKBWRCLK, negedge ADDRBWRADDR[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[9]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[10]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[11]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[12]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[13]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[14]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[15]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[2]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[3]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[4]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[5]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[6]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[7]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[8]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[9]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINPB_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[10]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[11]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[12]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[13]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[14]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[15]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[2]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[3]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[4]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[5]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[6]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[7]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[8]);
    $setuphold (posedge CLKBWRCLK, negedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[9]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[10]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[11]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[12]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[13]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[14]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[15]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[2]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[3]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[4]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[5]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[6]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[7]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[8]);
    $setuphold (posedge CLKBWRCLK, negedge DINBDIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[9]);
    $setuphold (posedge CLKBWRCLK, negedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPADINP_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPADINP_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge DINPBDINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPBDINP_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge DINPBDINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPBDINP_delay[1]);
    ...
    $setuphold (posedge CLKBWRCLK, negedge WEA[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge WEA[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge WEA[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[2]);
    $setuphold (posedge CLKBWRCLK, negedge WEA[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[3]);
    $setuphold (posedge CLKBWRCLK, negedge WEBWE[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[0]);
    $setuphold (posedge CLKBWRCLK, negedge WEBWE[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[1]);
    $setuphold (posedge CLKBWRCLK, negedge WEBWE[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[2]);
    $setuphold (posedge CLKBWRCLK, negedge WEBWE[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[3]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[10]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[2]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[3]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[4]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[5]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[6]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[7]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[8]);
    $setuphold (posedge CLKBWRCLK, posedge ADDRBWRADDR[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, ADDRBWRADDR_delay[9]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[10]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[11]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[12]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[13]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[14]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[15]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[2]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[3]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[4]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[5]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[6]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[7]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[8]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINB[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINB_delay[9]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINPB[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINPB_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge CASDINPB[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, CASDINPB_delay[1]);
    ...
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[10]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[11]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[12]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[13]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[14]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[15]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[2]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[3]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[4]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[5]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[6]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[7]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[8]);
    $setuphold (posedge CLKBWRCLK, posedge DINADIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINADIN_delay[9]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[10], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[10]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[11], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[11]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[12], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[12]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[13], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[13]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[14], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[14]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[15], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[15]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[2]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[3]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[4], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[4]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[5], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[5]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[6], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[6]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[7], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[7]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[8], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[8]);
    $setuphold (posedge CLKBWRCLK, posedge DINBDIN[9], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINBDIN_delay[9]);
    $setuphold (posedge CLKBWRCLK, posedge DINPADINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPADINP_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge DINPADINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPADINP_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge DINPBDINP[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPBDINP_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge DINPBDINP[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, DINPBDINP_delay[1]);
    ...
    $setuphold (posedge CLKBWRCLK, posedge WEA[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge WEA[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge WEA[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[2]);
    $setuphold (posedge CLKBWRCLK, posedge WEA[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEA_delay[3]);
    $setuphold (posedge CLKBWRCLK, posedge WEBWE[0], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[0]);
    $setuphold (posedge CLKBWRCLK, posedge WEBWE[1], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[1]);
    $setuphold (posedge CLKBWRCLK, posedge WEBWE[2], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[2]);
    $setuphold (posedge CLKBWRCLK, posedge WEBWE[3], 0:0:0, 0:0:0, notifier, clkbwrclk_en_p, clkbwrclk_en_p, CLKBWRCLK_delay, WEBWE_delay[3]);
    $width (negedge ARST_A, 0:0:0, 0, notifier);
    $width (negedge ARST_B, 0:0:0, 0, notifier);
    $width (negedge CLKARDCLK, 0:0:0, 0, notifier);
    $width (negedge CLKBWRCLK, 0:0:0, 0, notifier);
    $width (posedge ARST_A, 0:0:0, 0, notifier);
    $width (posedge ARST_B, 0:0:0, 0, notifier);
