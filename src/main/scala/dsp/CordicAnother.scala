...
//
//
//case class CordicAnother(algebraicMode: AlgebraicMode, rotationMode: RotationMode,
//                         iteration: Int, fractional: Int)
//  extends ChainsawGenerator {
//
//  override def name = s"cordic_${algebraicMode}_${rotationMode}_iter${iteration}_fractional$fractional"
//
//  /** --------
//   * golden model
//   * -------- */
...
//   * size information
//   * -------- */
//  override var inputTypes = _
//  override var outputTypes = _
//  /** --------
//   * timing information
//   * -------- */
//  override var inputFormat = _
//  override var outputFormat = _
...
//}
////
////  val amplitudeType = HardType(SFix(1 exp, -fractional exp)) // [-1,1]
////  val phaseType = HardType(SFix(2 exp, -fractional exp)) // [-pi, pi]
////
////  /** --------
