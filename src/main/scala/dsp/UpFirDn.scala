...
case class UpFirDnConfig(upSample: Int, multiple: Int,
  ...
  override def impl(dataIn: Seq[Any]) = {
    ...
    // drop leading results, size unchanged
  }
  ...
  override def implH = UpFirDn(this)
}

case class UpFirDn(config: UpFirDnConfig) extends TransformModule[SFix, SFix] {
